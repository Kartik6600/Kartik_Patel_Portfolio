  ...
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none bg-zinc-950">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-violet-900/40 blur-[120px]" />
        <div className="absolute top-[40%] left-[60%] w-[30%] h-[30%] rounded-full bg-emerald-900/20 blur-[100px]" />
      </div>
      <canvas
        ref={canvasRef}
